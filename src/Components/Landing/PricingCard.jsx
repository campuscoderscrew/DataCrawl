function Pill({show=false}) {
    if (show) {
        return (
            <div className="border-solid border-[1.31px] border-[#4B4B4B] py-1 px-4 flex items-center bg-[#7F7A7A]/20 rounded-[56.5px]">
                <img src="/landing/Sparkles.svg" className="mr-[8px] h-5" />
                <p className="text-[#DCDCDC] text-xs font-bold">Popular</p>
            </div>
        )
    }
}
    ...
    return (
        <>
            <div className="border-solid border-[1.1px] border-[#313131] bg-[linear-gradient(_#1E1E1E,_#111_50%)] rounded-[16.48px] max-w-md p-8 font-[Roboto] text-base">
                ...
                <p className="text-[#B4B4B4] mt-[24px] mb-[16px]">{description}</p>
                <div className="border-solid border-t-[1.26px] border-[#373737]" />
                <p className="text-[#B4B4B4] my-[32px]">
                    <span className="text-[#DCDCDC] text-5xl font-bold me-[8px]">${cost}</span>/month
                </p>
                <button className="w-full mb-[24px] p-2 text-sm rounded-[12.59px] text-white font-bold border-[1.26px] border-solid border-[#373737] hover:cursor-pointer transition duration-400 hover:bg-[#201e1e]">Get Started</button>
